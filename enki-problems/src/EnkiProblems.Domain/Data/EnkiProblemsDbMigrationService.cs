...
public class EnkiProblemsDbMigrationService : ITransientDependency
{
    public ILogger<EnkiProblemsDbMigrationService> Logger { get; set; }

    private readonly IDataSeeder _dataSeeder;
    private readonly IEnumerable<IEnkiProblemsDbSchemaMigrator> _dbSchemaMigrators;
    private readonly ITenantRepository _tenantRepository;
    private readonly ICurrentTenant _currentTenant;

    public EnkiProblemsDbMigrationService(
    ...
    )
    {
        ...
        Logger = NullLogger<EnkiProblemsDbMigrationService>.Instance;
    }
